...
# Exemplo de criação de abas nativas no Streamlit
aba_formulario, aba_graficos = st.tabs(["📝 Formulario", "📊 Gráficos"])
...
with aba_formulario:
    ...
    # =============================================================================
    with st.container(
        key=f"container_bloco_compdec_1_0_final_{ano_sel}", border=True
    ):
        with st.expander(
            "📌 Quesito 1.0 - Criação da COMPDEC ou Órgão Similar", expanded=True
        ):
            ...
            with c10_2:
                ...
                links_10_visuais = [
                    u[0] for u in re.findall(REGEX_PURE_URL, link_10 or "")
                ]
                if links_10_visuais:
                    placeholder_links_10.markdown(
                        "**Links Ativos:** "
                        + " | ".join([f"🔗 [{u}]({u})" for u in links_10_visuais])
                    )
    ...
    # =============================================================================
    with st.container(
        key=f"container_bloco_compdec_1_1_final_{ano_sel}", border=True
    ):
        with st.expander(
            "📌 Quesito 1.1 - Dados do Instrumento Normativo COMPDEC",
            expanded=True,
        ):
            ...
            st.caption(
                "ℹ *Preencha os campos abaixo e clique no botão 'Salvar Quesito 1.1' para registrar.*"
            )
            ...
            with c11_2:
                ...
                links_11_visuais = [
                    u[0] for u in re.findall(REGEX_PURE_URL, novo_link_11 or "")
                ] + [
                ...
                if links_11_visuais:
                    placeholder_links_11.markdown(
                        "**Links Ativos:** "
                        + " | ".join([f"🔗 [{u}]({u})" for u in links_11_visuais])
                    )
            ...
            if st.button(
                "💾 Salvar Quesito 1.1",
                key=f"btn_salvar_q11_{ano_sel}",
                type="primary",
            ):
                coments_atuais_11 = res_data.get("1.1", {}).get(
                    "comentarios", []
                )
                ...
                # Executa modal de aviso ANTES do rerun
                links_encontrados_11 = re.findall(
                    r"https?://[^\s]+", novo_valor_11
                ) + re.findall(r"https?://[^\s]+", novo_link_11)
    ...
    # =============================================================================
    with st.container(
        key=f"container_bloco_compdec_1_2_final_{ano_sel}", border=True
    ):
        with st.expander(
            "📌 Quesito 1.2 - Endereço Eletrônico do Instrumento Normativo",
            expanded=True,
        ):
            ...
            st.caption(
                "ℹ *Preencha os campos abaixo e clique no botão 'Salvar Quesito 1.2' para registrar.*"
            )

            dq12 = res_data.get("1.2") or {
                "valor": "",
                "pontos": 0.0,
                "link": "",
                "comentarios": [],
            ...
            with c12_2:
                ...
                links_12_visuais = [
                    u[0] for u in re.findall(REGEX_PURE_URL, novo_link_12 or "")
                ] + [
                ...
                if links_12_visuais:
                    placeholder_links_12.markdown(
                        "**Links Ativos:** "
                        + " | ".join([f"🔗 [{u}]({u})" for u in links_12_visuais])
                    )
            ...
            if st.button(
                "💾 Salvar Quesito 1.2",
                key=f"btn_salvar_q12_{ano_sel}",
                type="primary",
            ):
                coments_atuais_12 = res_data.get("1.2", {}).get(
                    "comentarios", []
                )
                ...
                links_encontrados_12 = re.findall(
                    r"https?://[^\s]+", novo_valor_12
                ) + re.findall(r"https?://[^\s]+", novo_link_12)
    ...
    # =============================================================================
    with st.container(
        key=f"container_bloco_compdec_1_3_final_{ano_sel}", border=True
    ):
        with st.expander(
            "📌 Quesito 1.3 - Secretaria ou Diretoria de Subordinação",
            expanded=True,
        ):
            ...
            st.caption(
                "ℹ *Preencha os campos abaixo e clique no botão 'Salvar Quesito 1.3' para registrar.*"
            )
            ...
            with c13_1:
                ...
                idx_13 = (
                    lista_opcoes_13.index(v_salvo_13)
                    if v_salvo_13 in lista_opcoes_13
                    else 0
                )
            ...
            with c13_2:
                ...
                links_13_visuais = [
                    u[0] for u in re.findall(REGEX_PURE_URL, link_13 or "")
                ]
                if links_13_visuais:
                    placeholder_links_13.markdown(
                        "**Links Ativos:** "
                        + " | ".join([f"🔗 [{u}]({u})" for u in links_13_visuais])
                    )
            ...
            if st.button(
                "💾 Salvar Quesito 1.3",
                key=f"btn_salvar_q13_{ano_sel}",
                type="primary",
            ):
                pts_calc_13 = opcoes_13.get(val_radio_13, 0.0)
                coments_atuais_13 = res_data.get("1.3", {}).get(
                    "comentarios", []
                )
                ...
                links_encontrados_13 = re.findall(
                    r"https?://[^\s]+", link_13 or ""
                )
            ...
            cor_txt_13 = (
                "#28a745"
                if pts_atuais_13 == 5.0
                else ("#dc3545" if val_atual_13 != "Selecione..." else "#6c757d")
            )
            st.markdown(
    ...
    # =============================================================================
    with st.container(
        key=f"container_bloco_compdec_1_4_final_{ano_sel}", border=True
    ):
        with st.expander(
            "📌 Quesito 1.4 - Atuação Sistêmica e Articulação da Defesa Civil",
            expanded=True,
        ):
            ...
            st.caption(
                "ℹ *Preencha os campos abaixo e clique no botão 'Salvar Quesito 1.4' para registrar.*"
            )
            ...
            with c14_1:
                ...
                idx_14 = (
                    lista_opcoes_14.index(v_salvo_14)
                    if v_salvo_14 in lista_opcoes_14
                    else 0
                )
            ...
            with c14_2:
                ...
                links_14_visuais = [
                    u[0] for u in re.findall(REGEX_PURE_URL, link_14 or "")
                ]
                if links_14_visuais:
                    placeholder_links_14.markdown(
                        "**Links Ativos:** "
                        + " | ".join([f"🔗 [{u}]({u})" for u in links_14_visuais])
                    )
            ...
            if st.button(
                "💾 Salvar Quesito 1.4",
                key=f"btn_salvar_q14_{ano_sel}",
                type="primary",
            ):
                pts_calc_14 = opcoes_14.get(val_radio_14, 0.0)
                coments_atuais_14 = res_data.get("1.4", {}).get(
                    "comentarios", []
                )
                ...
                links_encontrados_14 = re.findall(
                    r"https?://[^\s]+", link_14 or ""
                )
            ...
            cor_txt_14 = (
                "#28a745"
                if pts_atuais_14 >= 20.0
                else ("#dc3545" if val_atual_14 != "Selecione..." else "#6c757d")
            )
            st.markdown(
    ...
    # =============================================================================
    with st.container(
        key=f"container_bloco_compdec_1_5_final_{ano_sel}", border=True
    ):
        with st.expander(
            "📌 Quesito 1.5 - Motivo da Não Instituição da COMPDEC",
            expanded=True,
            ...
            st.caption(
                "ℹ *Preencha os campos abaixo e clique no botão 'Salvar Quesito 1.5' para registrar.*"
            )
            ...
            with c15_1:
                ...
                idx_15 = (
                    lista_opcoes_15.index(v_salvo_15)
                    if v_salvo_15 in lista_opcoes_15
                    else 0
                )
            ...
            with c15_2:
                ...
                links_15_visuais = [
                    u[0] for u in re.findall(REGEX_PURE_URL, link_15 or "")
                ]
                if links_15_visuais:
                    placeholder_links_15.markdown(
                        "**Links Ativos:** "
                        + " | ".join([f"🔗 [{u}]({u})" for u in links_15_visuais])
                    )
            ...
            if st.button(
                "💾 Salvar Quesito 1.5",
                key=f"btn_salvar_q15_{ano_sel}",
                type="primary",
            ):
                pts_calc_15 = opcoes_15.get(val_radio_15, 0.0)
                coments_atuais_15 = res_data.get("1.5", {}).get(
                    "comentarios", []
                )
                ...
                links_encontrados_15 = re.findall(
                    r"https?://[^\s]+", link_15 or ""
                )
            ...
            cor_txt_15 = (
                "#6c757d" if val_atual_15 == "Selecione..." else "#28a745"
            )
            st.markdown(
